...
# zeropie
제로파이 사내 커뮤니티(spring boot + react)
...
제로파이를 도입한이유는 협업의 효율성을 극대화하고자하는 필요성에서 시작되었습니다.
이러한 배경에서 양방향통신기술에 대한관심이커졌고, 이를통해우리가 활용할 수 있는 최적의솔루션을 찾은 결과, 그룹웨어를 도입하게 되었습니다. 

### 4. 주요기능

채팅기능, 게시판 기능, 캘린더 기능, 문서 기능, 프로젝트 기능

### 5. 팀 구성

윤혜지(조장), 박임재, 오아람, 김광은(총 4명)

### 6. 시연 영상

https://www.youtube.com/watch?v=z9AovY82XFQ
